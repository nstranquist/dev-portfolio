...
export const ProjectsContent = {
  "ProjectsHero": {
    ...
    subtitles: [
      "I am a Software Engineer with specialty in Javascript",
    ],
    ctaPrimary: "GitHub",
  ...
  "Projects": [
    ...
    },
    {
      id: "crypto-trader",
      title: "Crypto Trader",
      details: "A program in node.js that trades cryptocurrencies on binance exchange using tradingview email alerts",
      // imageUrl: "",
      imageTitle: "no screenshot for crypto trader available",
      codeUrl: "https://github.com/nstranquist/CryptoTrader",
      // demoUrl: ""
    },
    {
